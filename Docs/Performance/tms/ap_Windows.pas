...
type
  TatWindowsLibrary = class(TatScripterLibrary)
    procedure __QueryPerformanceCounter(AMachine: TatVirtualMachine);
    procedure __QueryPerformanceFrequency(AMachine: TatVirtualMachine);
...
//    procedure __EncryptFile(AMachine: TatVirtualMachine);
...
//    procedure __SetLayeredWindowAttributes(AMachine: TatVirtualMachine);
...
procedure TatWindowsLibrary.__QueryPerformanceCounter(AMachine: TatVirtualMachine);
  var
  Param0: TLargeInteger;
  AResult: variant;
begin
  with AMachine do
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := Windows.QueryPerformanceCounter(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;

procedure TatWindowsLibrary.__QueryPerformanceFrequency(AMachine: TatVirtualMachine);
  var
  Param0: TLargeInteger;
  AResult: variant;
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := Windows.QueryPerformanceFrequency(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
Param1 := _FILETIMEWrapper(integer(GetInputArg(1))).ObjToRec;
...
{
procedure TatWindowsLibrary.__EncryptFile(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.EncryptFile(PChar(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
}
...
begin
  with AMachine do
  begin
Param1 := _OFSTRUCTWrapper(integer(GetInputArg(1))).ObjToRec;
...
begin
  with AMachine do
  begin
Param1 := _WIN32_FIND_DATAAWrapper(integer(GetInputArg(1))).ObjToRec;
...
{
procedure TatWindowsLibrary.__SetLayeredWindowAttributes(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.SetLayeredWindowAttributes(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
}
...
begin
  with AMachine do
  begin
Param0 := TPointWrapper(integer(GetInputArg(0))).ObjToRec;
...
begin
  with AMachine do
  begin
Param1 := TPointWrapper(integer(GetInputArg(1))).ObjToRec;
...
begin
  with AMachine do
  begin
Param0 := TRectWrapper(integer(GetInputArg(0))).ObjToRec;
...
begin
  ...
  begin
    DefineMethod('QueryPerformanceCounter',1,tkVariant,nil,__QueryPerformanceCounter,false).SetVarArgs([0]);
    DefineMethod('QueryPerformanceFrequency',1,tkVariant,nil,__QueryPerformanceFrequency,false).SetVarArgs([0]);
    DefineMethod('GetCurrentTime',0,tkInteger,nil,__GetCurrentTime,false);
    DefineMethod('FreeModule',1,tkVariant,nil,__FreeModule,false).SetVarArgs([0]);
    DefineMethod('FreeLibrary',1,tkVariant,nil,__FreeLibrary,false);
    DefineMethod('GetVersion',0,tkInteger,nil,__GetVersion,false);
    DefineMethod('ExitProcess',1,tkNone,nil,__ExitProcess,false);
    DefineMethod('ExitThread',1,tkNone,nil,__ExitThread,false);
    DefineMethod('LockFile',5,tkVariant,nil,__LockFile,false);
    DefineMethod('UnlockFile',5,tkVariant,nil,__UnlockFile,false);
    DefineMethod('GetFileType',1,tkInteger,nil,__GetFileType,false);
    DefineMethod('FindClose',1,tkVariant,nil,__FindClose,false);
    DefineMethod('CloseHandle',1,tkVariant,nil,__CloseHandle,false);
    DefineMethod('FileTimeToLocalFileTime',2,tkVariant,nil,__FileTimeToLocalFileTime,false).SetVarArgs([1]);
    DefineMethod('FileTimeToSystemTime',2,tkVariant,nil,__FileTimeToSystemTime,false).SetVarArgs([1]);
    DefineMethod('FileTimeToDosDateTime',3,tkVariant,nil,__FileTimeToDosDateTime,false).SetVarArgs([1,2]);
    DefineMethod('GetTickCount',0,tkInteger,nil,__GetTickCount,false);
//    DefineMethod('EncryptFile',1,tkVariant,nil,__EncryptFile,false);
    DefineMethod('OpenFile',3,tkInteger,nil,__OpenFile,false).SetVarArgs([1]);
    DefineMethod('LoadLibrary',1,tkInteger,nil,__LoadLibrary,false);
    DefineMethod('GetCommandLine',0,tkVariant,nil,__GetCommandLine,false);
    DefineMethod('FindResource',3,tkInteger,nil,__FindResource,false);
    DefineMethod('SetCurrentDirectory',1,tkVariant,nil,__SetCurrentDirectory,false);
    DefineMethod('GetCurrentDirectory',2,tkInteger,nil,__GetCurrentDirectory,false);
    DefineMethod('RemoveDirectory',1,tkVariant,nil,__RemoveDirectory,false);
    DefineMethod('GetFileAttributes',1,tkInteger,nil,__GetFileAttributes,false);
    DefineMethod('DeleteFile',1,tkVariant,nil,__DeleteFile,false);
    DefineMethod('FindFirstFile',2,tkInteger,nil,__FindFirstFile,false).SetVarArgs([1]);
    DefineMethod('FindNextFile',2,tkVariant,nil,__FindNextFile,false).SetVarArgs([1]);
    DefineMethod('CopyFile',3,tkVariant,nil,__CopyFile,false);
    DefineMethod('MoveFile',2,tkVariant,nil,__MoveFile,false);
    DefineMethod('CopyMetaFile',2,tkInteger,nil,__CopyMetaFile,false);
    DefineMethod('CopyEnhMetaFile',2,tkInteger,nil,__CopyEnhMetaFile,false);
    DefineMethod('EndPath',1,tkVariant,nil,__EndPath,false);
    DefineMethod('ExitWindows',2,tkVariant,nil,__ExitWindows,false);
    DefineMethod('FlashWindow',2,tkVariant,nil,__FlashWindow,false);
//    DefineMethod('SetLayeredWindowAttributes',4,tkVariant,nil,__SetLayeredWindowAttributes,false);
    DefineMethod('CloseWindow',1,tkVariant,nil,__CloseWindow,false);
    DefineMethod('EndDialog',2,tkVariant,nil,__EndDialog,false);
    DefineMethod('OpenClipboard',1,tkVariant,nil,__OpenClipboard,false);
    DefineMethod('CloseClipboard',0,tkVariant,nil,__CloseClipboard,false);
    DefineMethod('GetClipboardFormatName',3,tkInteger,nil,__GetClipboardFormatName,false);
    DefineMethod('CharToOem',2,tkVariant,nil,__CharToOem,false);
    DefineMethod('CharToOemA',2,tkVariant,nil,__CharToOemA,false);
    DefineMethod('CharToOemW',2,tkVariant,nil,__CharToOemW,false);
    DefineMethod('OemToChar',2,tkVariant,nil,__OemToChar,false);
    DefineMethod('CharToOemBuff',3,tkVariant,nil,__CharToOemBuff,false);
    DefineMethod('CharToOemBuffA',3,tkVariant,nil,__CharToOemBuffA,false);
    DefineMethod('CharToOemBuffW',3,tkVariant,nil,__CharToOemBuffW,false);
    DefineMethod('CharUpper',1,tkVariant,nil,__CharUpper,false);
    DefineMethod('CharUpperA',1,tkVariant,nil,__CharUpperA,false);
    DefineMethod('CharUpperW',1,tkVariant,nil,__CharUpperW,false);
    DefineMethod('CharUpperBuff',2,tkInteger,nil,__CharUpperBuff,false);
    DefineMethod('CharUpperBuffA',2,tkInteger,nil,__CharUpperBuffA,false);
    DefineMethod('CharUpperBuffW',2,tkInteger,nil,__CharUpperBuffW,false);
    DefineMethod('CharLower',1,tkVariant,nil,__CharLower,false);
    DefineMethod('CharLowerA',1,tkVariant,nil,__CharLowerA,false);
    DefineMethod('CharLowerW',1,tkVariant,nil,__CharLowerW,false);
    DefineMethod('CharLowerBuff',2,tkInteger,nil,__CharLowerBuff,false);
    DefineMethod('CharLowerBuffA',2,tkInteger,nil,__CharLowerBuffA,false);
    DefineMethod('CharLowerBuffW',2,tkInteger,nil,__CharLowerBuffW,false);
    DefineMethod('CharNext',1,tkVariant,nil,__CharNext,false);
    DefineMethod('CharNextA',1,tkVariant,nil,__CharNextA,false);
    DefineMethod('CharNextW',1,tkVariant,nil,__CharNextW,false);
    DefineMethod('CharPrev',2,tkVariant,nil,__CharPrev,false);
    DefineMethod('CharPrevA',2,tkVariant,nil,__CharPrevA,false);
    DefineMethod('CharPrevW',2,tkVariant,nil,__CharPrevW,false);
    DefineMethod('CharNextExA',3,tkVariant,nil,__CharNextExA,false);
    DefineMethod('CharNextEx',3,tkVariant,nil,__CharNextEx,false);
    DefineMethod('CharPrevEx',4,tkVariant,nil,__CharPrevEx,false);
    DefineMethod('CharPrevExA',4,tkVariant,nil,__CharPrevExA,false);
    DefineMethod('AnsiToOem',2,tkVariant,nil,__AnsiToOem,false);
    DefineMethod('OemToAnsi',2,tkVariant,nil,__OemToAnsi,false);
    DefineMethod('AnsiToOemBuff',3,tkVariant,nil,__AnsiToOemBuff,false);
    DefineMethod('AnsiUpper',1,tkVariant,nil,__AnsiUpper,false);
    DefineMethod('AnsiUpperBuff',2,tkInteger,nil,__AnsiUpperBuff,false);
    DefineMethod('AnsiLower',1,tkVariant,nil,__AnsiLower,false);
    DefineMethod('AnsiLowerBuff',2,tkInteger,nil,__AnsiLowerBuff,false);
    DefineMethod('AnsiNext',1,tkVariant,nil,__AnsiNext,false);
    DefineMethod('AnsiPrev',2,tkVariant,nil,__AnsiPrev,false);
    DefineMethod('GetWindowDC',1,tkInteger,nil,__GetWindowDC,false);
    DefineMethod('MessageBox',4,tkInteger,nil,__MessageBox,false);
    DefineMethod('MessageBoxEx',5,tkInteger,nil,__MessageBoxEx,false);
    DefineMethod('MessageBeep',1,tkVariant,nil,__MessageBeep,false);
    DefineMethod('GetCaretPos',1,tkVariant,nil,__GetCaretPos,false).SetVarArgs([0]);
    DefineMethod('ClientToScreen',2,tkVariant,nil,__ClientToScreen,false).SetVarArgs([1]);
    DefineMethod('ScreenToClient',2,tkVariant,nil,__ScreenToClient,false).SetVarArgs([1]);
    DefineMethod('FrameRect',3,tkInteger,nil,__FrameRect,false);
    DefineMethod('CopyRect',2,tkVariant,nil,__CopyRect,false).SetVarArgs([0]);
    DefineMethod('FindWindow',2,tkInteger,nil,__FindWindow,false);
    DefineMethod('CopyImage',5,tkInteger,nil,__CopyImage,false);
    DefineMethod('CopyIcon',1,tkInteger,nil,__CopyIcon,false);
    DefineMethod('LoadString',4,tkInteger,nil,__LoadString,false);
    DefineMethod('FoldString',5,tkInteger,nil,__FoldString,false);
