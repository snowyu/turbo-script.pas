...
begin
  ...
  begin
    DefineMethod('EqualRect',2,tkVariant,nil,__EqualRect,false);
    DefineMethod('Rect',4,tkVariant,nil,__Rect,false);
    DefineMethod('Bounds',4,tkVariant,nil,__Bounds,false);
    DefineMethod('Point',2,tkVariant,nil,__Point,false);
    DefineMethod('PtInRect',2,tkVariant,nil,__PtInRect,false);
    DefineMethod('IntersectRect',3,tkVariant,nil,__IntersectRect,false);
    DefineMethod('UnionRect',3,tkVariant,nil,__UnionRect,false);
    DefineMethod('IsRectEmpty',1,tkVariant,nil,__IsRectEmpty,false);
    DefineMethod('OffsetRect',3,tkVariant,nil,__OffsetRect,false).SetVarArgs([0]);
    DefineMethod('CenterPoint',1,tkVariant,nil,__CenterPoint,false);
