...
procedure TTest_TurboExecutor.CreateTestObject;
begin
...
procedure TTest_TurboExecutor.Test_AddBufferToMem;
var
  i: Integer;
  vBuf: PChar;
  s: string;
...
procedure TTest_TurboExecutor.Test_AddByteToMem;
var
  i: Integer;
  vBuf: PByte;
  s: byte;
...
procedure TTest_TurboExecutor.Test_AddIntToMem;
var
  i: Integer;
  vBuf: PInteger;
  s: Integer;
