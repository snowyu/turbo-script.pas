{Turbo Script Compiler automatic Test}
unit uTurboCompilerTest;
...
type
  ...
  TTest_TurboCompiler = class (TTestCase)
  protected
...
procedure TTest_TurboCompiler.CreateTestObject;
begin
  FTestObject := TCustomTurboModule.Create();
end;

procedure TTest_TurboCompiler.Setup;
begin
  if not Assigned(FTestObject) then
    CreateTestObject;
end;

procedure TTest_TurboCompiler.TearDown;
begin
  FreeAndNil(FTestObject);
end;

procedure TTest_TurboCompiler.Test_AddBufferToMem;
var
  i: Integer;
  vBuf: PChar;
  s: string;
...
procedure TTest_TurboCompiler.Test_AddByteToMem;
var
  i: Integer;
  vBuf: PByte;
  s: byte;
...
procedure TTest_TurboCompiler.Test_AddIntToMem;
var
  i: Integer;
  vBuf: PInteger;
  s: Integer;
