{Turbo Script AppDomain automatic Test}
unit uTurboAppDomainTest;
...
type
  ...
  TTest_TurboAppDomain = class (TTestCase)
  protected
...
procedure TTest_TurboAppDomain.CreateTestObject;
begin
  FTestObject := TCustomTurboModule.Create();
end;

procedure TTest_TurboAppDomain.Setup;
begin
  if not Assigned(FTestObject) then
    CreateTestObject;
end;

procedure TTest_TurboAppDomain.TearDown;
begin
  FreeAndNil(FTestObject);
end;

procedure TTest_TurboAppDomain.Test_AddBufferToMem;
var
  i: Integer;
  vBuf: PChar;
  s: string;
...
procedure TTest_TurboAppDomain.Test_AddByteToMem;
var
  i: Integer;
  vBuf: PByte;
  s: byte;
...
procedure TTest_TurboAppDomain.Test_AddIntToMem;
var
  i: Integer;
  vBuf: PInteger;
  s: Integer;
